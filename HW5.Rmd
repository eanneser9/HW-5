...
ggplot()+
  ...
  labs(title = "Solved and Unsolved Murders in Boston, MA by Race",
       color = "Victim Race")
  
  
```

Racial disparities in the solving of murders in Boston, especially in majority BIPOC neighborhoods. 
